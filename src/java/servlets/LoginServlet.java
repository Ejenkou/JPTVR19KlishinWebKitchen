...
public class LoginServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        Buyer buyer = new Buyer("Vadim", "Soonvald", "51947485", "100");
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (path) {
            ...
            case "/login":
                ...
                if(user == null){
                    request.setAttribute("info", "Имя пользователя введено неверно, или неправильный пароль!");
                ...
                request.setAttribute("info", "Добро пожаловать!!");
            ...
            case "/logout":
                ...
                request.setAttribute("info", "До новых встреч! :)");
                request.getRequestDispatcher(LoginServlet.pathToJsp.getString("index")).forward(request, response);
                break;
